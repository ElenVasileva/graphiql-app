      ...
      <div className={styles.info__projectAndCourse}>
        <div className={styles.info__course}>
          ...
          <div className={styles.info__course_content}>
            <a href="https://rs.school/courses/reactjs">RSS React Course</a> is
            a free React course from Rolling Scope School. Everyone can study at
            RS School. But you should have sufficient base knowledge before the
            program begins. After successful completion of the course, students
